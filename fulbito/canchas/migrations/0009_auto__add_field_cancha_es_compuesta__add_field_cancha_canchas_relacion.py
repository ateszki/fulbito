...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Cancha.es_compuesta'
        db.add_column('canchas_cancha', 'es_compuesta',
    ...
    def backwards(self, orm):
        # Deleting field 'Cancha.es_compuesta'
        db.delete_column('canchas_cancha', 'es_compuesta')
    ...
    models = {
        ...
        'canchas.cancha': {
            ...
            'canchas_relacionadas': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['canchas.Cancha']", 'null': 'True', 'blank': 'True'}),
