...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ComplejoUsuario'
        db.create_table('canchas_complejousuario', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('complejo', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['canchas.Complejo'], unique=True, null=True, blank=True)),
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True, null=True, blank=True)),
            ('es_admin', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal('canchas', ['ComplejoUsuario'])

        # Removing M2M table for field groups on 'Complejo'
        db.delete_table('canchas_complejo_groups')


    def backwards(self, orm):
        # Deleting model 'ComplejoUsuario'
        db.delete_table('canchas_complejousuario')

        # Adding M2M table for field groups on 'Complejo'
        db.create_table('canchas_complejo_groups', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('complejo', models.ForeignKey(orm['canchas.complejo'], null=False)),
            ('group', models.ForeignKey(orm['auth.group'], null=False))
        ))
        db.create_unique('canchas_complejo_groups', ['complejo_id', 'group_id'])
    ...
    models = {
        ...
        'canchas.complejousuario': {
            ...
            'complejo': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['canchas.Complejo']", 'unique': 'True', 'null': 'True', 'blank': 'True'}),
