...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'ComplejoUsuario', fields ['complejo']
        db.delete_unique('canchas_complejousuario', ['complejo_id'])


        # Changing field 'ComplejoUsuario.complejo'
        db.alter_column('canchas_complejousuario', 'complejo_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['canchas.Complejo'], null=True))

    def backwards(self, orm):

        # Changing field 'ComplejoUsuario.complejo'
        db.alter_column('canchas_complejousuario', 'complejo_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['canchas.Complejo'], unique=True, null=True))
        # Adding unique constraint on 'ComplejoUsuario', fields ['complejo']
        db.create_unique('canchas_complejousuario', ['complejo_id'])
