...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Cancha.canchas_relacionadas'
        db.delete_column('canchas_cancha', 'canchas_relacionadas_id')

        # Adding M2M table for field canchas_relacionadas on 'Cancha'
        db.create_table('canchas_cancha_canchas_relacionadas', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('from_cancha', models.ForeignKey(orm['canchas.cancha'], null=False)),
            ('to_cancha', models.ForeignKey(orm['canchas.cancha'], null=False))
        ))
        db.create_unique('canchas_cancha_canchas_relacionadas', ['from_cancha_id', 'to_cancha_id'])


    def backwards(self, orm):
        # Adding field 'Cancha.canchas_relacionadas'
        db.add_column('canchas_cancha', 'canchas_relacionadas',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['canchas.Cancha'], null=True, blank=True),
                      keep_default=False)

        # Removing M2M table for field canchas_relacionadas on 'Cancha'
        db.delete_table('canchas_cancha_canchas_relacionadas')
    ...
    models = {
        ...
        'canchas.cancha': {
            ...
            'canchas_relacionadas': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'canchas_relacionadas_rel_+'", 'null': 'True', 'to': "orm['canchas.Cancha']"}),
            ...
            'es_compuesta': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
